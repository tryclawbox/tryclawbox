...
<img src="https://raw.githubusercontent.com/x402notary/x402notary/main/banner.jpg" width="100%" />
...
```bash
git clone https://github.com/x402notary/notary && cd notary && pnpm install && pnpm dev
```
...
<a href="https://github.com/x402notary/notary">View Repo →</a>
